...
?>
<input type="hidden" name="id" class="idEmpleado">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input required type="text" class="form-control claseTexto nombre" name="nombre">
    </div>
</div><br>
<div class="form-group row">
    <div class="col-md-3 text-end">
    ...
    <div class="col-md-9">
        <input required type="text" class="form-control claseTexto correo" name="email">
    </div>
</div><br>
<div class="form-group row">
    <div class="col-md-3 text-end">
    ...
    <div class="col-md-9">
        <div class="form-check">
            <input required class="form-check-input" type="radio" name="sexo" id="editarSexo1" value="M">
            <label class="form-check-label" for="editarSexo1">
                Masculino
            </label>
        </div>
        <div class="form-check">
            <input required class="form-check-input" type="radio" name="sexo" id="editarSexo2" value="F">
            <label class="form-check-label" for="editarSexo2">
                Femenino
            </label>
        </div>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <select name="area_id" class="form-control claseTexto area" required>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <textarea class="form-control claseTexto descripcion" name="descripcion" rows="3" required></textarea>
    </div>
</div><br>
<div class="form-group row">
    <div class="col-md-3 text-end">
    ...
    <div class="col-md-9">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="1" id="checkEditarBoletin" name="boletin">
            <label class="form-check-label" for="checkEditarBoletin">
